        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    productMarca = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Detalle_Orders_IdOrder",
                        column: x => x.IdOrder,
                        principalTable: "Orders",
                        principalColumn: "IdOrder",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Detalle_Products_IdProduct",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Detalle_IdOrder",
                table: "Detalle",
                column: "IdOrder");

            migrationBuilder.CreateIndex(
                name: "IX_Detalle_IdProduct",
                table: "Detalle",
                column: "IdProduct");
